...
HD_PWD='/home/alhua/VivadoProject/Laynernorm/Laynernorm.runs/align_mul_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log align_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source align_mul.tcl
