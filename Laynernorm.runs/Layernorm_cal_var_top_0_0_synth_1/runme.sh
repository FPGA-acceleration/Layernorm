...
HD_PWD='/home/alhua/VivadoProject/Laynernorm/Laynernorm.runs/Layernorm_cal_var_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Layernorm_cal_var_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Layernorm_cal_var_top_0_0.tcl
