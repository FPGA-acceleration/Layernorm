...
HD_PWD='/home/alhua/VivadoProject/Laynernorm/Laynernorm.runs/Layernorm_process_mean_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Layernorm_process_mean_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Layernorm_process_mean_top_0_0.tcl
