...
design_libs=(axis_infrastructure_v1_1_1 xil_defaultlib axis_broadcaster_v1_1_32)
...
compile()
{
  ...
  vlogan -work axis_broadcaster_v1_1_32 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
