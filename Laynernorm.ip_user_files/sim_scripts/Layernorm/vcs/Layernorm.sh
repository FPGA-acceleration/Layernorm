...
#
# Script generated by Vivado on Thu Oct 30 19:49:39 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Layernorm.sh
...
#
# Usage        : Layernorm.sh
#                Layernorm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Layernorm.sh [-reset_run]
#                Layernorm.sh [-reset_log]
#                Layernorm.sh [-help]
#
...
#                script (type 'Layernorm.sh -help' for more information).
#
...
# script info
echo -e "Layernorm.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Layernorm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Layernorm xil_defaultlib.glbl -o Layernorm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Layernorm_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alhua/VivadoProject/Laynernorm/Laynernorm.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key Layernorm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Layernorm_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Layernorm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Layernorm.sh [-help]\n\
Usage: Layernorm.sh [-step]\n\
Usage: Layernorm.sh [-lib_map_path]\n\
Usage: Layernorm.sh [-reset_run]\n\
Usage: Layernorm.sh [-reset_log]\n\
Usage: Layernorm.sh [-keep_index]\n\
Usage: Layernorm.sh [-noclean_files]\n\n\
