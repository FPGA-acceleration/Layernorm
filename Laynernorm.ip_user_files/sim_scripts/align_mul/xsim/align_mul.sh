...
#
# Script generated by Vivado on Wed Oct 29 16:25:17 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : align_mul.sh
...
#
# Usage        : align_mul.sh
#                align_mul.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                align_mul.sh [-reset_run]
#                align_mul.sh [-reset_log]
#                align_mul.sh [-help]
#
...
# script info
echo -e "align_mul.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./align_mul.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L c_shift_ram_v12_0_18 -L secureip -L xpm --snapshot align_mul xil_defaultlib.align_mul -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim align_mul -key {Behavioral:sim_1:Functional:align_mul} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb align_mul.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./align_mul.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: align_mul.sh [-help]\n\
Usage: align_mul.sh [-step]\n\
Usage: align_mul.sh [-lib_map_path]\n\
Usage: align_mul.sh [-reset_run]\n\
Usage: align_mul.sh [-reset_log]\n\
Usage: align_mul.sh [-keep_index]\n\
Usage: align_mul.sh [-noclean_files]\n\n\
