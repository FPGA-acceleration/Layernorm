...
-- Date        : Thu Oct 30 19:16:14 2025
-- Host        : Hua running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/alhua/VivadoProject/Laynernorm/Laynernorm.gen/sources_1/ip/axis_broadcaster_0/axis_broadcaster_0_sim_netlist.vhdl
...
entity axis_broadcaster_0_axis_broadcaster_v1_1_32_core is
  port (
  ...
  attribute ORIG_REF_NAME of axis_broadcaster_0_axis_broadcaster_v1_1_32_core : entity is "axis_broadcaster_v1_1_32_core";
end axis_broadcaster_0_axis_broadcaster_v1_1_32_core;

architecture STRUCTURE of axis_broadcaster_0_axis_broadcaster_v1_1_32_core is
...
entity axis_broadcaster_0_top_axis_broadcaster_0 is
  ...
  attribute C_FAMILY of axis_broadcaster_0_top_axis_broadcaster_0 : entity is "zynq";
  attribute C_M_AXIS_TDATA_WIDTH : integer;
  attribute C_M_AXIS_TDATA_WIDTH of axis_broadcaster_0_top_axis_broadcaster_0 : entity is 128;
  ...
  attribute C_S_AXIS_TDATA_WIDTH of axis_broadcaster_0_top_axis_broadcaster_0 : entity is 128;
  ...
  attribute P_TPAYLOAD_WIDTH of axis_broadcaster_0_top_axis_broadcaster_0 : entity is 128;
...
broadcaster_core: entity work.axis_broadcaster_0_axis_broadcaster_v1_1_32_core
     port map (
      aclk => aclk,
      aresetn => aresetn,
...
entity axis_broadcaster_0 is
  ...
  attribute X_CORE_INFO of axis_broadcaster_0 : entity is "top_axis_broadcaster_0,Vivado 2024.2";
...
architecture STRUCTURE of axis_broadcaster_0 is
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_tvalid : signal is "XIL_INTERFACENAME M01_AXIS, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
