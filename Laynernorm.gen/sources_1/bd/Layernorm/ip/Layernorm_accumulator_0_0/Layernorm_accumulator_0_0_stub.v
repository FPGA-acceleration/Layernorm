...
//               /home/alhua/VivadoProject/Laynernorm/Laynernorm.gen/sources_1/bd/Layernorm/ip/Layernorm_accumulator_0_0/Layernorm_accumulator_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "Layernorm_accumulator_0_0,accumulator,{}" *) (* CORE_GENERATION_INFO = "Layernorm_accumulator_0_0,accumulator,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=accumulator,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "accumulator,Vivado 2024.2" *) 
module Layernorm_accumulator_0_0(aclk, arstn, S_AXIS_TDATA, S_AXIS_TVALID, 
  S_AXIS_TREADY, M_AXIS_TDATA, M_AXIS_TVALID, M_AXIS_TLAST, M_AXIS_TREADY)
/* synthesis syn_black_box black_box_pad_pin="arstn,S_AXIS_TDATA[127:0],S_AXIS_TVALID,S_AXIS_TREADY,M_AXIS_TDATA[143:0],M_AXIS_TVALID,M_AXIS_TLAST,M_AXIS_TREADY" */
