...
// Date        : Thu Oct 30 19:38:14 2025
// Host        : Hua running 64-bit Ubuntu 22.04.5 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/alhua/VivadoProject/Laynernorm/Laynernorm.gen/sources_1/bd/Layernorm/ip/Layernorm_cal_var_top_0_0/Layernorm_cal_var_top_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "Layernorm_cal_var_top_0_0,cal_var_top,{}" *) (* CORE_GENERATION_INFO = "Layernorm_cal_var_top_0_0,cal_var_top,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=cal_var_top,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "cal_var_top,Vivado 2024.2" *) 
module Layernorm_cal_var_top_0_0(aclk, arstn, S_AXIS_0_TDATA, S_AXIS_0_TREADY, 
  S_AXIS_0_TVALID, S_AXIS_1_TDATA, S_AXIS_1_TREADY, S_AXIS_1_TVALID, M_AXIS_TDATA, 
  M_AXIS_TVALID, M_AXIS_TREADY)
/* synthesis syn_black_box black_box_pad_pin="arstn,S_AXIS_0_TDATA[143:0],S_AXIS_0_TREADY,S_AXIS_0_TVALID,S_AXIS_1_TDATA[15:0],S_AXIS_1_TREADY,S_AXIS_1_TVALID,M_AXIS_TDATA[143:0],M_AXIS_TVALID,M_AXIS_TREADY" */
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF M_AXIS:S_AXIS_0:S_AXIS_1, FREQ_HZ 200000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Layernorm_aclk, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
  input arstn;
